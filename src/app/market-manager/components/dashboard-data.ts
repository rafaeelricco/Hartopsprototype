// Dashboard data for Market Manager
// Scoped to the manager's assigned brandAmbassadors and events only
...
export interface TopBrandAmbassador {
  name: string;
...
export const dashboardStats: DashboardStat[] = [
  {
    ...
    value: 12,
    description: "Activities scheduled across your assigned brand ambassadors",
    href: "/market-manager/activities",
    trend: { value: 8, label: "vs last week" },
  },
  {
    label: "Active Activities Now",
    value: 2,
    description: "Activities currently in progress",
    href: "/market-manager/activities?filter=live",
    trend: { value: 0, label: "steady" },
  },
  {
    label: "Activities Requiring Attention",
    value: 5,
    description: "Activities needing staffing, review, or action",
    href: "/market-manager/activities?filter=attention",
...
export const upcomingEvents: UpcomingEvent[] = [
  {
    ...
    brandAmbassador: null,
    status: "Upcoming",
    requiresAttention: true,
    attentionReason: "No brand ambassador assigned",
  },
  {
    id: "evt-102",
  ...
  },
  {
    ...
    venue: "BevMo!, Hoboken",
    brandAmbassador: "James Rodriguez",
    status: "Completed",
    requiresAttention: true,
...
// Top brandAmbassadors by performance
export const topBrandAmbassadors: TopBrandAmbassador[] = [
