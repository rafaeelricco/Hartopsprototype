...
import {
  CURRENT_MARKET_MANAGER,
  type MarketManagerProfile,
} from "./settings-data";
...
const notificationCategories: NotificationCategory[] = [
  ...
  },
  {
    ...
    title: "Unstaffed Activities Warning",
    description:
      "Alert when an event is 7 days away with no brand ambassador assigned.",
    icon: AlertTriangle,
    defaultEnabled: true,
  },
  {
  ...
  {
    id: "failed-checkin",
    title: "Failed Brand Ambassador Check-In",
    description:
      "Alert when an brand ambassador has not completed geolocated check-in by event start time.",
    icon: XCircle,
    defaultEnabled: true,
  },
  {
    id: "ready-review",
    title: "Activity Ready for Review",
    description:
...
const faqItems: FaqItem[] = [
  {
    question: "How do I assign an brand ambassador to an event?",
    answer:
      "Navigate to Activities → click the event → in the Pre-Activity view, click 'Assign Brand Ambassador'. Select an brand ambassador from your roster, review their availability, then confirm the assignment.",
  },
  {
    question: "What happens when I finalize an event?",
    answer:
      "Finalization locks the event record permanently for all actors (you, the brand ambassador, and Trial Client Staff). It also terminates the brand ambassador's 24-hour post-event editing window immediately. This action is irreversible.",
  },
  {
    question: "Can I undo event finalization?",
    answer:
      "No. Activity finalization is irreversible in the current version. Please review all event data carefully before clicking 'Approve & Finalize'.",
  },
  {
    question: "Why can't I see all brand ambassadors or events?",
    answer:
      "Your dashboard and data views are scoped to your assigned brand ambassadors and events only. This is by design to keep your view focused. If you believe you're missing data, contact your Hart Ops administrator.",
  },
  {
    question: "How do I contact an brand ambassador?",
    answer:
      "Go to Brand Ambassadors → click the brand ambassador → use the email or phone contact links. These will open your email client or phone dialer directly.",
  },
  {
    question: "What does the 'Activities Requiring Attention' card mean?",
    answer:
      "This shows events that need your action — either unstaffed events (no brand ambassador assigned) or completed events awaiting your finalization review.",
  },
];
...
function AccountTab() {
  const [profile, setProfile] = useState<MarketManagerProfile>({
    ...CURRENT_MARKET_MANAGER,
  });
  ...
  const handleCancel = () => {
    setProfile({ ...CURRENT_MARKET_MANAGER });
    setEditing(false);
  };
    ...
    <div className="space-y-6 pt-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={() => navigate("/brand ambassador")}
