...
// The date vocabulary lives in shared/ so the dashboard and the Reports runner
// use one control and one resolver (reporting brief §2). Re-exported here so
...
export type { DateRange, RangeShortcut } from "@/app/shared/data/date-range";
