...
// Used by both Market Manager and Hart Ops brandAmbassador detail pages. Takes
// primitive rate/history/overrides props so it doesn't couple to either
// platform's BrandAmbassador shape.
// =============================================================================
...
export function CompensationPanel({
  ...
  function handleSaveRate(input: {
    ...
    const newEntry: RateHistoryEntry = {
      id: `rh-${brandAmbassadorId}-${Date.now()}`,
      rate: input.rate,
  ...
  return (
    <div className="space-y-3">
        ...
        {frequentOverridesHint && (
          ...
          >
            ...
            <div style={{ fontSize: "0.8125rem", color: "#92400E" }}>
              This brandAmbassador has had {recentOverrides.length} overrides in the
      ...
      <EditRateModal
        ...
        brandAmbassadorName={brandAmbassadorName}
