...
export function EditRateModal({
  ...
  const previewMessage = useMemo(() => {
    ...
    return `New rate of $${parsedRate.toFixed(2)}/hr takes effect on ${formattedDate} for ${upcomingEventsCount} upcoming ${upcomingEventsCount === 1 ? "event" : "events"} already scheduled for ${educatorName}.`;
  }, [rateValid, parsedRate, effectiveDate, upcomingEventsCount, educatorName]);
