// =============================================================================
// Template data types and mock data.
// Templates are optional, reusable presets within a Campaign that group a subset
// of products and channel context. When creating an Activity (Event or Survey),
// users can pick a template to pre-fill its setup, or start from a blank.
// Hierarchy: Campaign → Template (optional) → Activity (Event | Survey)
// =============================================================================
...
export interface Template {
  ...
  venueType?: Activity["venueType"] | undefined;
  createdAt: string;
}

let nextTemplateId = 10;
export function generateTemplateId(): string {
  return `tpl-${nextTemplateId++}`;
}

// ---------------------------------------------------------------------------
// Mock templates for existing campaigns
// ---------------------------------------------------------------------------
