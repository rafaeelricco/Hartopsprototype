...
export interface AssignedBrandAmbassadorRecord {
...
export interface Activity {
  ...
  assignedBrandAmbassadors?: AssignedBrandAmbassadorRecord[];
...
export const VENUE_TYPES = [
  {
    value: "off-premises" as const,
    label: "Off-Premises",
    description: "Retail stores, grocery, liquor shops",
  },
  {
    value: "on-premises" as const,
    label: "On-Premises",
    description: "Bars, restaurants, venues",
  },
  {
...
export const OBJECTIVES: Objective[] = [
  {
    ...
    description: "Measure and increase brand visibility at the event location",
  },
  {
    id: "drive-sales",
    label: "Drive Sales",
    description: "Track sales volume, conversions, and revenue generated",
  },
  {
  ...
  },
  {
    ...
    description: "Capture interaction quality, feedback, and social mentions",
  },
  {
    id: "product-education",
    label: "Product Education",
    description: "Assess knowledge transfer and training completion rates",
  },
  {
    id: "market-research",
    label: "Market Research",
    description: "Collect surveys, demographics, and trend data",
  },
];
...
export const OBJECTIVE_MODULE_MAP: Record<string, DataModule[]> = {
  "brand-awareness": [
    {
      ...
      description: "Aggregate visibility rating based on placement and signage",
      sampleValue: "8.4",
      sampleType: "score",
    },
    {
      id: "impressions",
      label: "Impressions Tracker",
      description: "Estimated foot traffic and eyeball count",
      sampleValue: "2,340",
      sampleType: "number",
    },
    {
      ...
      description: "Geo-tagged event photos with timestamps",
      sampleValue: "12 photos",
      sampleType: "text",
    },
  ],
  "drive-sales": [
    {
      id: "sales-volume",
      label: "Sales Volume Tracker",
      description: "Units sold by SKU during the event",
      sampleValue: "187",
      sampleType: "number",
    },
    {
      ...
      description: "Sample-to-purchase conversion rates",
      sampleValue: "34%",
      sampleType: "percent",
    },
    {
      ...
      description: "Total revenue and average transaction value",
      sampleValue: "$4,280",
      sampleType: "currency",
    },
  ],
  "competitive-intel": [
    {
      id: "competitor-log",
      label: "Competitor Presence Log",
      description: "Competitor brands and activities observed",
      sampleValue: "4 brands",
      sampleType: "text",
    },
    {
      id: "price-matrix",
      label: "Price Comparison Matrix",
      description: "Side-by-side pricing for key SKUs",
      sampleValue: "6 SKUs",
      sampleType: "text",
    },
    {
      id: "market-share-notes",
      label: "Market Share Notes",
      description: "Qualitative observations on shelf share and positioning",
      sampleValue: "3 notes",
      sampleType: "text",
    },
  ],
  "consumer-engagement": [
    {
      ...
      description: "Interaction count, dwell time, and participation rate",
      sampleValue: "156",
      sampleType: "number",
    },
    {
      ...
      description: "Structured feedback forms and sentiment scores",
      sampleValue: "4.6/5",
      sampleType: "score",
    },
    {
      ...
      description: "Hashtag tracking and social media mentions",
      sampleValue: "28",
      sampleType: "number",
    },
  ],
  "product-education": [
    {
      ...
      description: "Pre/post quiz scores for product knowledge",
      sampleValue: "82%",
      sampleType: "percent",
    },
    {
      id: "qa-log",
      label: "Q&A Log",
      description: "Questions asked by consumers and staff responses",
      sampleValue: "14 Q&As",
      sampleType: "text",
    },
    {
      ...
      description: "Staff training module completion rates",
      sampleValue: "96%",
      sampleType: "percent",
    },
  ],
  "market-research": [
    {
      ...
      description: "Structured survey data with response rates",
      sampleValue: "89",
      sampleType: "number",
    },
    {
      id: "demographics",
      label: "Demographics Collector",
      description: "Age, gender, and location data of attendees",
      sampleValue: "72 profiles",
      sampleType: "text",
    },
    {
      id: "trend-analysis",
      label: "Trend Analysis",
      description: "Emerging preferences and consumption patterns",
      sampleValue: "5 trends",
      sampleType: "text",
    },
  ],
};
...
export function getDataModulesForObjectives(
  objectiveIds: string[],
): DataModule[] {
...
export const ADVANCED_MODULES: AdvancedModule[] = [
  {
    ...
    description:
      "Photograph and score shelf placement, facings, and compliance",
  },
  {
    id: "menu-analysis",
    label: "Menu Analysis",
    description: "Document menu placement, pricing, and feature status",
  },
  {
    id: "foot-traffic",
    label: "Foot Traffic Counter",
    description: "Automated or manual foot traffic counting at the venue",
  },
  {
    id: "weather-impact",
    label: "Weather Impact Log",
    description:
      "Record weather conditions and correlate with event performance",
  },
  {
    id: "inventory-audit",
    label: "Inventory Audit",
    description: "Pre- and post-event inventory counts for participating SKUs",
  },
  {
    id: "pos-integration",
    label: "POS Integration Data",
    description: "Pull point-of-sale data from partnered registers",
  },
];
...
export const INITIAL_ACTIVITIES: Activity[] = [
  // camp-1: Summer Seltzer Launch (18 events — show 3 representative)
  {
    ...
    assignedBrandAmbassadors: [
      { brandAmbassadorId: "EDU-001", name: "Maria Santos", status: "Accepted" },
      { brandAmbassadorId: "EDU-003", name: "Ashley Chen", status: "Accepted" },
    ],
    sampleConfigs: [
  ...
  },
  {
    ...
    assignedBrandAmbassadors: [
      { brandAmbassadorId: "EDU-005", name: "Sophia Rivera", status: "Accepted" },
      { brandAmbassadorId: "EDU-007", name: "Lauren Nguyen", status: "Pending" },
    ],
  ...
  },
  {
    ...
    assignmentStatus: "assigned",
    assignedBrandAmbassadors: [
      { brandAmbassadorId: "EDU-002", name: "James Mitchell", status: "Accepted" },
      { brandAmbassadorId: "EDU-006", name: "Marcus Taylor", status: "Accepted" },
    ],
  ...
  // camp-3: Music Festival Sponsorship (6 events — show 2)
  {
    ...
    assignmentStatus: "pending",
    assignedBrandAmbassadors: [
      { brandAmbassadorId: "EDU-009", name: "Jasmine Williams", status: "Pending" },
    ],
    sampleConfigs: [
      { skuId: "sku-001" },
  ...
  // camp-5: Campus Ambassador Program (12 events — show 2)
  {
    ...
    assignmentStatus: "pending",
    assignedBrandAmbassadors: [
      { brandAmbassadorId: "EDU-008", name: "Sofia Rodriguez", status: "Pending" },
    ],
  ...
  },
  {
    ...
    assignmentStatus: "pending",
    assignedBrandAmbassadors: [
      { brandAmbassadorId: "EDU-010", name: "Nina Patel", status: "Pending" },
    ],
  ...
  },
  {
    ...
    assignedBrandAmbassadors: [
      { brandAmbassadorId: "EDU-003", name: "Ashley Chen", status: "Accepted" },
      { brandAmbassadorId: "EDU-012", name: "Tyler Robinson", status: "Pending" },
      { brandAmbassadorId: "EDU-010", name: "Kevin O'Brien", status: "Accepted" },
    ],
