// =============================================================================
// Event Creation Wizard — MM-UI-003
// 4-step guided flow: Event Basics → Objectives → Report Preview → Advanced
// Sequential enforcement: cannot skip ahead.
// Polish: report-first preview, educator mobile frame, generation transition,
// selection counter, additive-module context, save-as-draft.
// =============================================================================
...
const STEPS = [
  { num: 1, label: "Event Basics", icon: FileText },
  { num: 2, label: "Objectives", icon: Target },
  { num: 3, label: "Report Preview", icon: FileText },
...
export function EventWizard({ campaignId, open, onClose, onCreated }: EventWizardProps) {
  ...
  function handleNext() {
    ...
    // Gap #3: Auto-generation transition for Step 3
    if (step === 2) {
      setGenerating(true);
      setStep(3);
  ...
  return (
    <div className="fixed inset-0 z-50 flex font-[Inter]">
      ...
      {/* Wizard panel */}
      <div
        className="relative ml-auto w-full max-w-2xl bg-white flex flex-col shadow-2xl"
      ...
      >
        ...
        {/* ── Progress stepper ─────────────────────────────────────────── */}
        <div className="flex items-center gap-0 px-6 py-3 border-b border-[#F1F5F9] bg-[#FAFBFC]">
          {STEPS.map((s, i) => {
...
function Step1Basics({
  ...
  return (
    <div>
      <h3 style={{ fontSize: "1rem", color: "#0F172A" }} className="mb-1">
        Event Basics
      </h3>
...
// =============================================================================
// Step 2 — Objectives (Gap #4: selection counter)
// =============================================================================
...
// =============================================================================
// Step 3 — Intelligent Report Preview (Gap #1, #2, #3)
// =============================================================================

function Step3ReportPreview({
  data,
  modules,
  modulesByObjective,
  showEducator,
  ...
  return (
    <div style={{ animation: "fadeInUp 0.3s ease-out" }}>
      ...
      {!showEducator ? (
        /* ── Report mock-up (Gap #1: per-objective sections with sample data) */
        <div className="border border-[#E2E8F0] rounded-xl overflow-hidden bg-white">
          ...
          {/* Per-objective report sections (Gap #1 core) */}
          {modulesByObjective.map((group, gi) => (
            ...
            >
              ...
              {/* Module cards with sample data */}
              <div className="px-5 pb-4 grid grid-cols-1 sm:grid-cols-3 gap-2.5">
        ...
        /* ── Educator Experience (Gap #2: richer mobile preview) ───────── */
        <div className="flex justify-center">
          ...
          >
            ...
            {/* Module sections grouped by objective */}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Show mini form hint for second item */}
                          {gi === 0 && mi === 1 && (
...
// =============================================================================
// Step 4 — Advanced Customization (Gap #5: additive context)
// =============================================================================
