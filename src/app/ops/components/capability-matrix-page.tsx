...
type CapabilityRow = {
  ...
  staff: AccessLevel;
  brandAmbassadorMgr: AccessLevel;
  brandAmbassador: AccessLevel;
};
...
const ROLES = [
  {
    ...
    icon: Shield,
    description:
      "Full platform oversight — manages organizations, brand ambassadors, events, reports, and system settings across all agencies.",
  },
  {
    name: "Staff",
  ...
  },
  {
    ...
    icon: Users,
    description:
      "Coordinates brand ambassador assignments, approves cancellations, and manages the field team for their territory.",
  },
  {
...
const CATEGORIES: CapabilityCategory[] = [
  {
    ...
    capabilities: [
      ...
      {
        capability: "Activity activity dashboard",
        operator: false,
        staff: true,
        brandAmbassadorMgr: true,
        brandAmbassador: false,
      },
      {
        capability: "Top brand ambassadors leaderboard",
        operator: false,
        staff: false,
        brandAmbassadorMgr: true,
        brandAmbassador: false,
  ...
  },
  {
    ...
    name: "Brand Ambassadors & Availability",
    icon: Users,
    capabilities: [
      {
        capability: "View all brand ambassadors (cross-org)",
        operator: true,
        staff: false,
        brandAmbassadorMgr: false,
        brandAmbassador: false,
      ...
      {
        capability: "View brand ambassador detail & history",
        operator: true,
        staff: false,
        brandAmbassadorMgr: true,
        brandAmbassador: false,
      ...
      {
        capability: "Manage brand ambassador roster",
        operator: false,
        staff: false,
        brandAmbassadorMgr: true,
        brandAmbassador: false,
                  ...
                  <TableBody>
                    {cat.capabilities.map((row) => (
                      <TableRow key={row.capability}>
                        ...
                        <TableCell>
                          <AccessIndicator value={row.brandAmbassadorMgr} />
                        </TableCell>
                        <TableCell>
                          <AccessIndicator value={row.brandAmbassador} />
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
