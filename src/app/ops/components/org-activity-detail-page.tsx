...
import type { EventRecord } from "./activities-page";
...
export function OrgActivityDetailPage() {
  ...
  const event = MOCK_EVENTS.find(
    (e) => e.id === activityId && e.orgId === orgId,
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {!org
              ...
              : `No event with ID "${activityId}" exists for ${org.name}.`}
          </p>
        </div>
      </div>
    );
