    ...
    <LegalPageLayout title="Privacy Policy" lastUpdated="March 1, 2026">
      <section>
        ...
        <p className="text-muted-foreground">
          Hart Agency ("we", "our", or "us") is committed to protecting your
          privacy. This Privacy Policy explains how we collect, use, disclose,
          and safeguard your information when you use the Hart Ops platform
      ...
      <section>
        ...
        <ul className="list-disc pl-6 text-muted-foreground space-y-1 mb-3">
          ...
          <li>
            Data you upload or enter into the Service, including organizational
            and event data.
          </li>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 text-muted-foreground space-y-1">
          <li>
            ...
            who assist us in operating the Service, subject to confidentiality
            obligations.
          </li>
          <li>
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          ...
          encryption in transit and at rest, access controls, regular security
          assessments, and employee training. However, no method of transmission
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          ...
          active or as needed to provide the Service. We will also retain and
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          ...
          control cookie preferences through your browser settings. Please note
          that disabling certain cookies may affect the functionality of the
          Service. For more details, refer to our Cookie Policy.
        </p>
      </section>
