...
function makeChecklist(
  ...
  const items: { id: string; label: string }[] = [
    ...
    { id: "brand ambassador", label: "BrandAmbassador assignment needed" },
...
export const MOCK_DRAFT_EVENTS: DraftEventRecord[] = [
  ...
  },
  {
    ...
    missingFields: ["brand ambassador"],
    notes:
      "Part of batch upload (12 events). BrandAmbassador assignment pending — LA market.",
    status: "pending",
    reviewChecklist: makeChecklist({
      account: true,
      date: true,
  ...
  },
  {
    ...
    notes:
      "Client wants premium brand ambassador with cocktail certification. Budget TBD — awaiting approval from brand manager.",
    status: "pending",
  ...
  },
  {
    ...
    missingFields: [],
    notes:
      "Repeat event from last month. Same setup. BrandAmbassador Maria Santos requested by client.",
    status: "pending",
    reviewChecklist: makeChecklist({
      account: true,
      date: true,
  ...
  },
  {
    ...
    notes:
      "One-off event — no campaign. Need 4 brand ambassadors minimum. Premium event rates apply.",
    status: "pending",
    reviewChecklist: makeChecklist({ account: true, date: true }),
    products: [],
  ...
  },
  {
    ...
    missingFields: ["brand ambassador"],
    notes:
      "Need brand ambassador with virtual event experience. Client will ship kits to attendees.",
    status: "pending",
    reviewChecklist: makeChecklist({
      date: true,
      products: true,
